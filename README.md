...
**Capstone-summit** The repository serves as a showcase to demonstrate proficiency in utilizing different tools and implementing established practices acquired during prior stages. The project encompasses a website comprising two primary pages: the homepage and the about page.
...
Feel free to check the [issues page](https://github.com/AlyAtalla/AlyAtalla.github.io/issues).
